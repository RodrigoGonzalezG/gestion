...
$mysqli = getConnSec();
$sql_imp_salida   = "SELECT * FROM reporte where IdTurno = '$dato'";
...
<page class="fondo">
    ...
    <table class="entrega" style="">
        <tr>
            <td rowspan="5" style="border:1px; width: 30%;">
                <span class="letra">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    Recibido</span>
            ...
            <td style="width: 62.5%;"><span class="letra">Atención:</span> <span style="font-size:9px;"><?php echo $row['TipoAtencion'];?></span></td>
        </tr>
        <tr>
            <td><span class="letra">Otro tipo de atención:</span> <span style="font-size:9px;"><?php echo $row['OtroAtencion'];?></span></td>
        </tr>
      
        <tr>
            <td><span class="letra">Volante SG:</span> <span style="font-size:9px;"><?php echo $row['VoSg'];?></span></td>
        </tr>
        <tr>
            <td><span class="letra">Volante SG salida:</span> <span style="font-size:9px;"><?php echo $row['VoSalida'];?></span></td>
        </tr>
    </table>
    ...
    <table class="entrega" style="border:1px;">
        ...
        <tr>
            <th style="text-align:center;width:5%;" class="Borde">Turnado a</th>
            <th style="text-align:center;width:20.2%;" class="Borde">Respuesta</th>
            <th style="text-align:center;width:20.2%;" class="Borde">Observaciones</th>
        </tr>
        <?php
    $Sql   = "SELECT * FROM reporte where IdTurno = '$dato'";
...
?>
    ...
    <table class="entrega">
        <tr>
            <th style="border:1px;text-align:center;">Turnado a</th>
        </tr>
        <tr>
            <td style="width:92.2%;text-align:left; font-size:12px; font-weight: bold;" class="break"><?php echo $row['NombreArea'];?></td>
        </tr>
    </table>

    <table class="entrega">
        <tr>
            <td rowspan="5" style="border:1px; width: 30.5%;">
                <span class="letra">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    Recibido</span>
                <br><br><br><br><br><br><br>
                <hr>
